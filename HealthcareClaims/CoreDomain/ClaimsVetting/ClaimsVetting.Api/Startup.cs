...
using ClaimsVetting.Api.Extensions;
using ClaimsVetting.Api.Filters;
...
using ClaimsVetting.Infrastructure.Queue.Configuration;
...
namespace ClaimsVetting.Api
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddTransient<IBatchReportUriGenerator, BatchReportUriGenerator>();
			services.AddTransient<IBatchVettingReportStoreService, BatchVettingReportStoreService>();
			services.AddTransient<IBatchContentService, BatchContentService>();
			services.AddTransient<IBatchRepository, BatchRepository>();
			services.AddTransient<IDictionaryCodesService, DictionaryCodesService>();

			services.AddTransient<IBatchVettingPlugin, DiagnosisVettingPlugin>();
			services.AddTransient<IBatchVettingPlugin, ProcedureVettingPlugin>();
			services.AddTransient<IBatchVettingPlugin, MedicineVettingPlugin>();
		...
		private void AddConfiguration(IServiceCollection services)
		{
			...
			var dictionaryCodesOptions = new DictionaryCodesOptions();
			Configuration.Bind("DictionaryCodes", dictionaryCodesOptions);
			services.AddSingleton<IDictionaryCodesOptions>(dictionaryCodesOptions);
		}
